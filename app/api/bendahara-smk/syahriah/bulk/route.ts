...
// POST create multiple Syahriah transactions (Bulk Billing) for SMK santri
export async function POST(request: NextRequest) {
  try {
    ...
    // Get all SMK santri with their beasiswa status
    ...
    return NextResponse.json({
      ...
      summary: {
        ...
        skipped: {
          ...
          nonSMK: skippedNonSMK,
          total: skippedBeasiswa + skippedNonAktif + skippedExisting + skippedNonSMK,
        },
      },
      results,
    })
